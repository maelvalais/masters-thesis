...
\todo[inline]{should I talk about the complexity of such using Fourier instead of the “sparse” convolution we use for the “restrained” gradient?}
...
This section details the method used for making sure that the “full” gradient is appropriate for adding points to supports.
...
$$\y=\hat{\y} + \bm{b}$$
with $b$ following a centered Gaussian distribution $\mathcal{N}(0,\sigma^2I)$ and $\hat{\y}$ the noiseless signal. We see that the distance $||b||$ is always smaller than the projected distance.
