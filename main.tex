...
\item because of the convolution $D*x$, each component $x^f$ of the code $x$ is the same size as the target image $y$. We will talk about this blockwise code a bit farther
\end{itemize}
