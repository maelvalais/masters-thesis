...
\newgls[text={convolutional tree model}]{treemodel}{Convolutional Tree Model}{is a model of dictionary enforcing a specific structure based on convolutions of sparse kernels, proposed in \cite{chabiron_optimization_2016}. Such dictionary is called “convolutional tree dictionary”}
