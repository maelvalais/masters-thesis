\documentclass[11pt, a4paper,onecolumn, oneside,french]{report}
% openany -> for drafts
...
\usepackage{setspace} % for reducing space between lines in toc
...
% For better \chapter{} headings
\usepackage{titlesec}
\definecolor{gray75}{gray}{0.75}
\titleformat{\chapter}[hang]{\Huge\bfseries}{\thechapter\hspace{20pt}\textcolor{gray75}{|}\hspace{20pt}}{0pt}{\Huge\bfseries}

% Even with \usepackage{titlesec}, we can't change the chapter heading whitespace. So I reduce the heading whitespaces here:
\titlespacing*{\chapter}{0pt}{-20pt}{30pt}

% For removing whitespaces from toc (table of contents)
\usepackage{tocloft}
\setlength\cftbeforetoctitleskip{15pt}
\setlength\cftaftertoctitleskip{30pt}


% For hiding a section/chapter from the toc
% Usage: \tocless\chapter{My hidden chapter}
\newcommand{\nocontentsline}[3]{}
