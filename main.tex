...
\noindent
For a $128 \times 128$ target image and using the tree and codes presented in the \cref{fig_xp_explain}, the execution time of this algorithm is about 3 hours (although being parallelized on 32 threads); moreover, the algorithm must be executed each time we add an element, thus making it practically unusable for choosing the support elements to be added.
