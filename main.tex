...
\end{align}
where $\lVert . \rVert_F$ denotes the Frobenius norm and $\lVert . \rVert_1$ is the $l_1$ norm defined by \todo{correct?} $\lVert \x \rVert_1 = \sum_{i,j} |\x_i|$.
...
The \emph{Sparse Coding step}\footnote{See \cref{sec_ksvd}, \cpageref{sec_ksvd}} optimizes along $\x$; this step basically uses OMP \cref{alg_omp} or any other pursuit algorithm. The \emph{Dictionary Update step} optimizes along $\D$. This is the step the authors of \cite{chabiron_optimization_2016} worked on.
