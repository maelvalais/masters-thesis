...
Our idea is to use the same principle when adding elements to supports $(s^e)_{e \in \mathcal{E}}$.
...
\begin{algorithm}[!ht]
  ...
  \begin{algorithmic}[0]
    ...
    \State $(k^e)_{e \in \mathcal{E}} = \underset{(h^e)_{e \in \mathcal{E}}}{\arg\min} \quad \Phi ((h^e)_{e \in \mathcal{E}})$ \quad s.t. $h^e \in D^e$ \quad $\forall e$ \Comment{common starting point}
