...
\begin{figure}[!h]\centering
    ...
    \includegraphics[width=\textwidth]{figures/xp_add_bruteforce/xp_add_pt_size128x128_scale2_angle1_K3_S3_node1_target.png}
    \end{subfigure}
\begin{subfigure}[b]{0.49\textwidth}\centering
\includegraphics[width=\textwidth]{figures/xp_add_bruteforce/xp_add_pt_size128x128_scale2_angle1_K3_S3_node1_approx.png}
\end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}\centering
    \includegraphics[width=\textwidth]{figures/xp_add_bruteforce/xp_add_pt_size128x128_scale2_angle1_K3_S3_node1_obj_matrix.png}
    \end{subfigure}
\end{figure}
...
\begin{figure}[!h]\centering
    \begin{subfigure}[b]{0.49\textwidth}\centering
    \includegraphics[width=\textwidth]{figures/xp_add_bruteforce/xp_add_pt_size128x128_scale2_angle1_K3_S3_node2_target.png}
    \end{subfigure}
\begin{subfigure}[b]{0.49\textwidth}\centering
\includegraphics[width=\textwidth]{figures/xp_add_bruteforce/xp_add_pt_size128x128_scale2_angle1_K3_S3_node2_approx.png}
\end{subfigure}
   \begin{subfigure}[b]{0.49\textwidth}\centering
    \includegraphics[width=\textwidth]{figures/xp_add_bruteforce/xp_add_pt_size128x128_scale2_angle1_K3_S3_node2_obj_matrix.png}
    \end{subfigure}
\end{figure}
...
\begin{figure}[!h]\centering
    \begin{subfigure}[b]{0.49\textwidth}\centering
    \includegraphics[width=\textwidth]{figures/xp_add_bruteforce/xp_add_pt_size128x128_scale2_angle1_K3_S3_node3_target.png}
    \end{subfigure}
\begin{subfigure}[b]{0.49\textwidth}\centering
\includegraphics[width=\textwidth]{figures/xp_add_bruteforce/xp_add_pt_size128x128_scale2_angle1_K3_S3_node3_approx.png}
\end{subfigure}
   \begin{subfigure}[b]{0.49\textwidth}\centering
    \includegraphics[width=\textwidth]{figures/xp_add_bruteforce/xp_add_pt_size128x128_scale2_angle1_K3_S3_node3_obj_matrix.png}
    \end{subfigure}
\end{figure}
...
\begin{figure}[!h]\centering
    \begin{subfigure}[b]{0.49\textwidth}\centering
    \includegraphics[width=\textwidth]{figures/xp_add_bruteforce/xp_add_pt_size128x128_scale2_angle1_K3_S3_node4_target.png}
    \end{subfigure}
\begin{subfigure}[b]{0.49\textwidth}\centering
\includegraphics[width=\textwidth]{figures/xp_add_bruteforce/xp_add_pt_size128x128_scale2_angle1_K3_S3_node4_approx.png}
\end{subfigure}
   \begin{subfigure}[b]{0.49\textwidth}\centering
    \includegraphics[width=\textwidth]{figures/xp_add_bruteforce/xp_add_pt_size128x128_scale2_angle1_K3_S3_node4_obj_matrix.png}
    \end{subfigure}
\end{figure}
