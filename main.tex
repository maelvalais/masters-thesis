...
\begin{subfigure}[b]{0.28\linewidth}\centering
\includegraphics[width=\linewidth]{figures/before_after/gainafter_approx.pdf}
\caption{Approx.\@ after adding}\label{fig_beforeafter-gainadd-approx_after}
\end{subfigure}
\begin{subfigure}[b]{0.34\linewidth}\centering
\includegraphics[width=\linewidth]{figures/before_after/gainafter_partgrad4.pdf}
\caption{Gradient after}\label{fig_beforeafter-gainadd-grad_after}
\end{subfigure}
\begin{subfigure}[b]{0.34\linewidth}\centering
\includegraphics[width=\linewidth]{figures/before_after/gainafter_partgrad4_bestvalues.pdf}
\caption{Best values of \ref{fig_beforeafter-gainadd-grad_after}}\label{fig_beforeafter-grad_after_best}
\end{subfigure}

\begin{subfigure}[b]{0.28\linewidth}\centering
\includegraphics[width=\linewidth]{figures/before_after/gradafter_approx.pdf}
\caption{Approx.\@ after adding}\label{fig_beforeafter-grad-approx_after}
\end{subfigure}
\begin{subfigure}[b]{0.34\linewidth}\centering
\includegraphics[width=\linewidth]{figures/before_after/gradafter_partgrad4.pdf}
\caption{Gradient after}\label{fig_beforeafter-gradadd-grad_after}
\end{subfigure}
\begin{subfigure}[b]{0.34\linewidth}\centering
\includegraphics[width=\linewidth]{figures/before_after/gradafter_partgrad4_bestvalues.pdf}
\caption{Best values of \ref{fig_beforeafter-gradadd-grad_after}}\label{fig_beforeafter-gradadd-grad_after_best}
\end{subfigure}
