...
Allowing us to add or remove elements from kernel supports may yield the result showed in figure \ref

\begin{figure}
\includegraphics[width=\textwidth]{figures/example-optimized-support.pdf}
\caption{\label{fig_example_optimal_support}}
\end{figure}
