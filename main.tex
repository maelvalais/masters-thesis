...
\section{Checking that the gradient is correct}
...
$$\lim_{\epsilon \rightarrow 0} \frac{E((h^e)_{e \in \mathcal{E}}+\epsilon e_i) - E((h^e)_{e \in \mathcal{E}}) }{\epsilon} =_? \nabla_i E((h^e)_{e \in \mathcal{E}})$$
...
\end{subfigure}
\caption{Checking that the "full-kernel" gradient is correct. We compare it to the finite-difference gradient and make the $\epsilon$ tend to 0.} \label{fig_verif_gradient}
\end{figure}
