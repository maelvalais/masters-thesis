...
%I would first like to thank my adviser, Mahmood R. Azimi-Sadjadi, for his support and invalu- able guidance throughout the course of my research. He has taught me the value of well-developed research. His time and assistance has been greatly appreciated throughout my graduate education.%I would also like to thank my committee members, Dr. Ali Pezeshki and Dr. F. Jay Breidt, for their time and assistance.%I would like to thank the Office of Naval Research (ONR) and the Naval Surface Warfare Center (NSWC) in Panama City, Florida for providing the funding and the data used in this project. This project has been funded by the Office of Naval Research (ONR-3210E) under contract number N00014-12-C-0017. Without the funding from ONR and the data from NSWC, this work would have never been completed.%I would also like to thank my colleagues in the Signal and Image Processing Lab. They have provided an excellent working environment. Special thanks to Nick Klausner for his much needed help and advice.%Finally, I would like to thank my family for their support and guidance throughout my entire education.
...
%Firstly, I would like to thank Professor Kozerke, with whom I had done my semester project, for suggesting this thesis and for taking his time to oversee my project. Secondly, a big thanks to my two advisors, Con- stantin and Georg: both of you were fantastic throughout the entire project and especially towards the end, when things got a little hectic. They were always there when I got stuck and without them this project would have been impossible to complete.%A big thanks to the people in the offices F69 and F71, past and present, for making the time of this thesis and the semester project last year more fun and providing some distractions: Mark (or Marc, I always for- get), Momo, Gari, Arturo (commonly known as R2), MingMingMingMingMingMingMing, Datta, Eleanor, Mock, Peeeeeeeter, Livie, Claude, and Sascha (who is actually Alexander).%Also a big thanks to the rest of the students of the Biomedical Engineering Program, the old as well as the new, especially Yoran, Enrico, Emma, Silvan, and Robert Bobert of Bobington.%A big thanks to my parents and my brother for their continued love and support, and another thanks to my brother for proofreading my report.%This time, before they insist on being mentioned, a shout-out to the ex2c-crowd (in a very particular order): Ba ̈bi, Big Pete, (Little) Pete, Erik, Thomas, Roman, Juchli, Sa ̈mi, and our youngest and newest friend, Noah.


%First and foremost, I would like to express my deep gratitude to my research supervisor Dr.Kaamran Raahemifar, for his patient guidance, enthusiastic encouragement and useful critiques of this research work. I would also like to thank Dr. Raahemifar, for his advice and assistance in keeping my progress on schedule throughout my academic years at Ryerson.%I would like to thank Mathi for his input and supportive criticism towards the thesis and continued support in all my endeavors.%Finally, I wish to thank my parents, Manonmany and Tharmalingam, and my wife Kasthuri for their continued love, support and encouragement in all my endeavors.
...
\begin{table}[hbt]\centering
  \begin{tabular}{>{\bf}rl}
   Document version & \gitFirstTagDescribe{} \\
...
\end{enumerate}
This chapter covers the protocols and results of the various experiments that have been conducted to solve the above problems.\todo{Re-do this intro}
...
\end{figure}\todo{Add figures with “after adding best grad”}
...
\noindent
We also observe that when adding a point to the support (materialized by the \nth{10} small square), the largest gradient values “shift” to the south-west. Thus, adding a point to the support has an effect on the whole neighborhood.
...
\end{subfigure}
\caption{Results after using \cref{alg_omppalmtree}. Each support has been cropped to the minimal square that contains all elements; the number under each support gives the width of that square.}\label{fig_test_omppalmtree}
\end{figure}\todo{tell the size of each square}
...
\todo[inline]{explain that “heuristically”, the problem of scattered gradients is due to...}
...
\noindent 
This can be interpreted as an identifiability problem of the atoms. (one feature corresponds to one curvelet among the 16 that forms the target).
...
This problem can also be considered (to an extent) as an \emph{overlearning} problem as it reflects atoms that are too specialized with respect to the learning images and thus, cannot be used for other images.

\noindent
Ideally, we would like all elements to be centered around the origin\footnote{In the figures, the origin is at the center of the image} in order to have well identified atoms. However, the gradient indicated elements that were far from each other.
...
\noindent
\Cref{fig_scattered_support-tree} illustrates this problem; every support has its elements scattered instead of being concentrated around the origin. The corresponding gradient, shown in \cref{fig_scattered_support-grad}, has multiple “local” maxima that are far from the origin. 
