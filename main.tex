...
\noindent
The dashed square surrounding the 9 support elements (indicated by small squares) represents the limits of the reachable support, i.e., the points that can be reached by the resulting atom (when convoluting the kernels of the branch). This explains the size restriction of the atom approximation in \cref{fig_gain_n4-approx}: outside of the reachable support, the approximation pixels are zeros (the gray surrounding the atom).
